...
class Payment extends React.Component {
    ...
    addBalance = async () => {
        ...
        const { card_holder, card_number, security_code, exp_date, type, funds } = this.state
        ...
        if (card_holder != '' && security_code != '' && exp_date != '' && card_number != '') {
            ...
            if (this.state.errorExpDateStatus == true) {
                await this.props.addBalance(username, card_number, firstName, lastName, security_code, exp_date, type, funds)
            }
        ...
        return (
            <View style={{ flex:1 }}>
                ...
                <View style={styles.container}>
                    ...
                    <Button onPress={this.addBalance} >Add</Button>
...
const mapDispatchToProps = dispatch => ({
    addBalance: (username, card_number, first_name, last_name, security_code, exp_date, type, funds) => dispatch(addBalance(username, card_number, first_name, last_name, security_code, exp_date, type, funds))
})
